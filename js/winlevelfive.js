var winLevelFiveState = {
	create: function () {
		...
		var startLabel = game.add.text(80, 250, 'The only thing stopping you from making it back into the Minecraft world is the same Ender Dragon that cast you out. Watch out for its flames, attack it with your sword. Press "W" to continue.', {font: '25px Courier', fill: '#ffffff', wordWrap: true, wordWrapWidth: 550});
		// var button = game.add.button(game.world.centerX - 184.5, 350, 'button', this.actionOnClick, this, 0);
